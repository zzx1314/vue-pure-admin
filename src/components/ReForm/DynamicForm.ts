...
export type IDynamicFormItemCallbackAdditionalProps<T> = {
  [P in keyof T]?: T[P] | IDynamicFormItemCallback<T[P]>;
};
...
export interface IDynamicFormItem {
   ...
   */
  additionalProps?:
    | Record<string, unknown | IDynamicFormItemCallback<unknown>>
    | unknown;
  /**
   * 附加组件插槽。
   */
