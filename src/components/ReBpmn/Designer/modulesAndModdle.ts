...
// moddle 定义文件
import activitiModdleDescriptors from "@/components/ReBpmn/moddle-extensions/activiti.json";
import camundaModdleDescriptors from "@/components/ReBpmn/moddle-extensions/camunda.json";
import flowableModdleDescriptors from "@/components/ReBpmn/moddle-extensions/flowable.json";
import MiyueModdleDescriptors from "@/components/ReBpmn/moddle-extensions/miyue.json";
...
// 自定义 modules 扩展模块
import translate from "@/components/ReBpmn/additional-modules/Translate";
import Rules from "@/components/ReBpmn/additional-modules/Rules";
import AutoPlace from "@/components/ReBpmn/additional-modules/AutoPlace";
import ElementFactory from "@/components/ReBpmn/additional-modules/ElementFactory";
import EnhancementPalette from "@/components/ReBpmn/additional-modules/Palette/EnhancementPalette";
import RewritePalette from "@/components/ReBpmn/additional-modules/Palette/RewritePalette";
import EnhancementContextPad from "@/components/ReBpmn/additional-modules/ContextPad/EnhancementContextPad";
import RewriteContextPad from "@/components/ReBpmn/additional-modules/ContextPad/RewriteContextPad";
import EnhancementRenderer from "@/components/ReBpmn/additional-modules/Renderer/EnhancementRenderer";
import RewriteRenderer from "@/components/ReBpmn/additional-modules/Renderer/RewriteRenderer";

// 流程图校验部分
import lintModule from "bpmn-js-bpmnlint";
import bpmnlint from "@/components/ReBpmn/additional-modules/Lint/bpmnlint";
...
export default function (settings: Ref<EditorSettings>): ModulesAndModdles {
  ...
  if (settings.value.otherModule) {
    ...
    options["elementFactory"] = {
      "bpmn:Task": { width: 100, height: 100 },
