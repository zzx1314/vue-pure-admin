          ...
          <div class="settings-model">
            <NCard
              ...
              v-slots={{
                default: () => (
                  ...
                  >
                    <NFormItem label={t("configForm.language")}>
                      <NRadioGroup
                        v-model={[editorSettings.value.language, "value"]}
                      >
                    ...
                    <NFormItem label={t("configForm.templateChooser")}>
                      <NSwitch
                        v-model={[
                          editorSettings.value.templateChooser,
                          "value"
                        ]}
                      ></NSwitch>
                    </NFormItem>
                    ...
                    <NFormItem label={t("configForm.customContextmenu")}>
                      <NSwitch
                        v-model={[
                          editorSettings.value.customContextmenu,
                          "value"
                        ]}
                      ></NSwitch>
                    </NFormItem>
                    <NFormItem label={t("configForm.processEngine")}>
                      ...
                      >
                        <NRadio value="camunda">
                          {t("configForm.camunda")}
                        </NRadio>
                        <NRadio value="activiti">
                          {t("configForm.activiti")}
                        </NRadio>
                        <NRadio value="flowable">
                          {t("configForm.flowable")}
                        </NRadio>
                      </NRadioGroup>
                    </NFormItem>
                    <NFormItem label={t("configForm.background")}>
                      <NRadioGroup v-model={[editorSettings.value.bg, "value"]}>
                        <NRadio value="grid-image">
                    ...
                    <NFormItem label={t("configForm.penalMode")}>
                      <NRadioGroup
                        v-model={[editorSettings.value.penalMode, "value"]}
                      >
                        <NRadio value="default">
                          {t("configForm.default")}
                        </NRadio>
                    ...
                    <NFormItem label={t("configForm.paletteMode")}>
                      ...
                      >
                        ...
                        <NRadio value="rewrite">
                          {t("configForm.rewrite")}
                        </NRadio>
                        <NRadio value="enhancement">
                          ...
                          return (
                            <div class="theme-item">
                              ...
                              <NColorPicker
                                ...
                                showAlpha={false}
                                v-model={[
                                  editorSettings.value.customTheme[key],
                                  "value"
                                ]}
                              ></NColorPicker>
                            </div>
                ...
                footer: () => <div class="tips-message"></div>
              }}
            ></NCard>
          </div>
        </NModal>
