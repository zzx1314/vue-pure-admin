...
import type { Element, Connection, Shape } from "diagram-js/lib/model/Types";
...
class RewriteRenderer extends BaseRenderer {
  public _renderer: undefined | any;
  public _drawPath: (
    parentGfx: SVGElement,
    d: string,
    attrs?: Object
  ) => SVGPathElement;
  public handlers: undefined | any;
  ...
  constructor(
    ...
    const presetColor = {
      ...
      defaultTaskColor: "#000000",
      defaultLabelColor: "#000000",
      defaultGatewayColor: "#fb863c",
      defaultSequenceColor: "#000000"
    };
    const presetOpacity = {
    ...
    function addMarker(id, options) {
      ...
      let defs = domQuery("defs", (canvas as any)._svg);
      if (!defs) {
        defs = svgCreate("defs");
    ...
    const handlers = (this.handlers = {
      ...
      "bpmn:Association": function (parentGfx, element, attrs) {
        ...
        return drawLine(
          parentGfx,
          (element as Element as Connection).waypoints,
          attrs
        );
      },
