...
.center .lingxA {
  ...
  left: 47%;
  opacity: 0;
  animation: lingx-a 2s linear infinite;
}
...
.center .lingxB {
  ...
  left: 58%;
  opacity: 0;
  animation: lingx-b 2.2s linear infinite;
}
...
.center .lingxC {
  ...
  left: 40%;
  opacity: 0;
  animation: lingx-c 1.7s linear infinite;
}
...
.center .lingxD {
  ...
  left: 41%;
  opacity: 0;
  animation: lingx-c 2.7s linear infinite;
}
...
.center .lingxE {
  ...
  left: 54%;
  opacity: 0;
  animation: lingx-b 1.2s linear infinite;
}
...
.center .lingxF {
  ...
  left: 53%;
  opacity: 0;
  animation: lingx-a 1.4s linear infinite;
}
