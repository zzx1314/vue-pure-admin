...
(function (global, factory) {
	 ...
	 * @example
	 *
	 * // use it inside any diagram components by injecting `translate`.
	 *
	...
	/**
	 * A components that manages shape styles
	 */
	function Styles() {
	 ...
	 *
	 * This components is used to communicate across a diagram instance.
	...
	function bootstrap(bootstrapModules) {
	  ...
	  components.forEach(function(c) {
	    ...
	    try {
	      ...
	      // eagerly resolve components (fn or string)
	      injector[typeof c === 'string' ? 'get' : 'invoke'](c);
	    } catch (e) {
	      console.error('Failed to instantiate components');
	      console.error(e.stack);
	...
	*/
	 ...
	 * logging components that integrates with interaction events:
	 *
	 *
	 * ```javascript
	 *
